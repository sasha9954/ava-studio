...
export const PROJECT_MODES = [
  {
    ...
    label_en: 'General manual project',
    description_ru: 'Без специальной логики. Ручная раскадровка, промты и монтаж.',
    ...
    mode_contract: {
      contract_ref: 'manual_general_v1',
      label_ru: 'Обычный проект',
      core_rule: 'Use existing timing, scene notes, prompts and media without special mode logic.',
      rules_ru: [
      ...
      prompt_hint_ru: 'Обычная ручная раскадровка без специальной логики режима.',
    },
    codex_task_defaults: {
      ...
      mode_prompt_ru: 'Обычный проект без специальной логики режима.',
